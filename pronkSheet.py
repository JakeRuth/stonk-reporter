...
stock_tickers_input = input('Enter stock tickers (comma separated, no spaces): ')
...
for ticker in stock_tickers:
    ...
    stock_data['Operating Expense'].append(operating_expense / 1000000)
    ...
    stock_data['Goodwill'].append(excel_helpers.string_to_float(most_recent_balance_q['goodwill']) / 1000000)
    stock_data['Intangible Assets'].append(excel_helpers.string_to_float(most_recent_balance_q['intangibleAssets']) / 1000000)
